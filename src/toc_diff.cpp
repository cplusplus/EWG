...
auto find_file(std::string const & status) -> std::string {
    if( 0 == status.find("Tentatively") ) {
        return "ewg-active.html";
    }

    auto stat = remove_qualifier(status);
    return stat == "TC1"            ?  "ewg-defects.html"
         : stat == "CD1"            ?  "ewg-defects.html"
         : stat == "WP"             ?  "ewg-defects.html"
         : stat == "C++11"          ?  "ewg-defects.html"
         : stat == "Resolved"       ?  "ewg-defects.html"
         : stat == "DR"             ?  "ewg-defects.html"
         : stat == "TRDec"          ?  "ewg-defects.html"
         : stat == "Dup"            ?  "ewg-closed.html"
         : stat == "NAD"            ?  "ewg-closed.html"
         : stat == "NAD Future"     ?  "ewg-closed.html"
         : stat == "NAD Editorial"  ?  "ewg-closed.html"
         : stat == "NAD Concepts"   ?  "ewg-closed.html"
         : stat == "Deferred"       ?  "ewg-active.html"
         : stat == "Ready"          ?  "ewg-active.html"
         : stat == "Review"         ?  "ewg-active.html"
         : stat == "New"            ?  "ewg-active.html"
         : stat == "Open"           ?  "ewg-active.html"
         : throw std::runtime_error{"unknown status " + stat};
}


auto is_active(std::string const & stat) -> bool {
    return find_file(stat) == "ewg-active.html";
}
...
int main (int argc, char* const argv[]) {
   try {
      ...
      auto const old_issues = read_issues(path + "meta-data/ewg-toc.old.html");
      auto const new_issues = read_issues(path + "ewg-toc.html");
